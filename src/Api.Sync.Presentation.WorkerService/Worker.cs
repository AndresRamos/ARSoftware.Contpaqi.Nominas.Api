...
public sealed class Worker : BackgroundService
{
    ...
    private readonly ContpaqiNominasConfig _contpaqiContabilidadConfig;
    ...
    public Worker(ILogger<Worker> logger, IMediator mediator, IOptions<ApiSyncConfig> apiSyncConfigOptions,
        IHostApplicationLifetime hostApplicationLifetime, IOptions<ContpaqiNominasConfig> contpaqiContabilidadConfigOptions,
